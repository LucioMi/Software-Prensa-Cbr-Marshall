...
forca_relatorio = [];                                              #valores de força em pontos especificos necessarios no relatorio
...
def gerar_dados():
    ...
    for x in range (0,len(eixo_x_deslocamento)):
        if eixo_x_deslocamento[x] == 0.63:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 1.27:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 1.90:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 2.54:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 3.17:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 3.81:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 5.08:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 6.35:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 7.32:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 8.89:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 10.16:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 11.43:
            forca_relatorio.append(eixo_y_forca[x])
        elif eixo_x_deslocamento[x] == 12.70:
            forca_relatorio.append(eixo_y_forca[x])
...
def gerar_relatorio_cbr():    
    ...
    global massa_amostra_cilindro,massa_cilindro,massa_esp_ap_seca,volume,peso_esp_umido,teor_umidade_media,massa_amosta,leitura_exp0,leitura_exp1
    global leitura_exp2,leitura_exp3,leitura_exp4,altura_inicial,exp_umidade_otima
