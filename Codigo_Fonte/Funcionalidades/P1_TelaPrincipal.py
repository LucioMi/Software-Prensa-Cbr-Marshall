...
FundoTela1 = PhotoImage(file=r"Funcionalidades\tela1_app1.png")                #guarda a imagem de fundo em uma variavel
...
tela1.iconbitmap(default=r"Funcionalidades\tela1.ico")              #define o icone do aplicativo (formato ico 16x16 px)
